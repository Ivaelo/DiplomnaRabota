...
namespace Diplomna.Migrations
{
    ...
    [Migration("20221214190223_DBContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diplomna.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            password = "$2a$11$GJTvjkBMgl1rk0twirjATeHBfvbwRHoiIdvgIxpqZoJnxKC07wn5K"
                        });
                });
            ...
            modelBuilder.Entity("Diplomna.Entities.Units", b =>
                {
                    b.HasOne("Diplomna.Entities.Courses", null)
                        .WithMany("Units")
            ...
            modelBuilder.Entity("Diplomna.Entities.Videos", b =>
                {
                    b.HasOne("Diplomna.Entities.Units", null)
                        .WithMany("Videos")
